...
Funcionalidade: Teste automatizado no site SampleApp
    ...
    Cenario: Preencher os campos do formulário
        ...
        E digito no campo Date of Birth a data "11/20/1992"
        ...
        E seleciono opcao Ultimate
        E clico em Next 
        Entao digito  no campo E-mail "fer@gmail.com"
        E digito no campo Username "FerDamasio"
        E digito no campo Password "Ons2131"
        E digito no campo Confirm Password "Ons2131"
        Entao clico em Send
        E verifico a mensagem de sucesso "Sending e-mail success!"